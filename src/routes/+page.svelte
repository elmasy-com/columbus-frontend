	...
	<div class="space-y-10 text-center">
		...
		<!-- <figure>
			...
			<svg
				...
				><defs id="defs47" /><sodipodi:namedview
					id="namedview45"
					pagecolor="#ffffff"
					bordercolor="#666666"
					borderopacity="1.0"
				...
				<g id="g42" transform="matrix(1.2780286,0,0,1.2780286,-164.14943,-153.68032)">
					<circle class="st0" cx="785" cy="564.90002" r="60" id="circle34" />
					<path
						class="st1"
		...
		{#if $totalDomain == 0 && $totalSub == 0}
			<p>Columbus Project is a subdomain discovery service with an easy to integrate API.</p>
		{:else}
			<p>
